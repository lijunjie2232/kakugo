        ...
        verticalLayout {
            ...
            scrollView {
                verticalLayout {
                    ...
                    appTitleImage(this@KatakanaMenuActivity).lparams(
                        width = matchParent,
                        height = dip(80)
                    ) {
                        margin = dip(8)
                    ...
                    verticalLayout {
                        button(R.string.katakana_to_hiragana) {
                            setOnClickListener {
                                startTest(
                                    this@KatakanaMenuActivity,
                        ...
                        separator(this@KatakanaMenuActivity).lparams(height = dip(1)) {
                            margin = dip(8)
                        }
